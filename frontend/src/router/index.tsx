    ...
    children: [
      {
        ...
        children: [
          ...
          { path: "ai/dataset-analysis", element: <Navigate to="/ai/analysis" replace /> },
          { path: "ai/model-analysis", element: <Navigate to="/ai/analysis?mode=model" replace /> },
          { path: "ai/report-generator", element: <Navigate to="/reports/generate" replace /> },
